...
let ResetPasswordService = class ResetPasswordService {
    ...
    execute({ token, password }) {
        return __awaiter(this, void 0, void 0, function* () {
            const userToken = yield this.userTokensRepository.decode(token);
            if (!userToken)
                throw new AppError_1.default('Missing authentication token');
            const user = yield this.usersRepository.findById(userToken.id);
            if (user) {
